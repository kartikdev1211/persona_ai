...
class SetupFocusStep extends StatefulWidget {
  final PersonaSetupNotifier notifier;

  const SetupFocusStep({super.key, required this.notifier});

  @override
  State<SetupFocusStep> createState() => _SetupFocusStepState();
}

class _SetupFocusStepState extends State<SetupFocusStep> {
  int _selected = 0;

  @override
  void initState() {
    super.initState();
    _selected = widget.notifier.focusGoalIndex;
  }

  void _select(int i) {
    setState(() => _selected = i);
    widget.notifier.focusGoalIndex = i;
  }
